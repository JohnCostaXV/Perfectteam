...
msg_id = None
msg_user = None
RANDOM_STATUS = ["e construindo", "suporte 24 horas"]
...
async def on_member_join(member):
  ...
  embed = discord.Embed(
      ...
      color=COR,
      description="Bem-vindo ao nosso discord,\nEsperamos que seja educado e que leia as regras."
  )
  embed.set_thumbnail(
...
async def on_message(message):
    ...
    if message.content.startswith('!aaaaaaa'):
        embed = discord.Embed(
            title="SUPORTE",
            color=COR,
    ...
    if message.content.startswith('!serverinfo'):
        ...
        embedserver.set_footer(text="PerfectTeam © 2018", icon_url="https://i.imgur.com/9euTj6A.png")
